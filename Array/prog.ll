; ModuleID = 'reverse_an_array.cpp'
source_filename = "reverse_an_array.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_reverse_an_array.cpp, i8* null }]
...
define dso_local void @_Z5solvePiii(i32* %0, i32 %1, i32 %2) #4 {
...
24:                                               ; preds = %12
  ...
  %26 = sub nsw i32 %25, 1
  call void @_Z5solvePiii(i32* %11, i32 0, i32 %26)
...
31:                                               ; preds = %27
  ...
  %37 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %36, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_reverse_an_array.cpp() #0 section ".text.startup" {
